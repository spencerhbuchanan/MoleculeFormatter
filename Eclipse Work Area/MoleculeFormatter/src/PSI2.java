...
public class PSI2
{
	public static void runPSI2(Scanner psiScanner) {						//Pass the scanner from the menu to this function
		...
		System.out.println("Printing a random number between zero and the absolute value of numberOne: " + rng.nextInt(Math.abs(numberOne)));
		...
		System.out.println("numberOne > numberTwo ? \"#1 is greater\" : \"#2 is greater\" =\t" + greater);
		
		System.out.println("numberOne + numberTwo: " + (numberOne + numberTwo));
		System.out.println("numberOne - numberTwo: " + (numberOne - numberTwo));
		System.out.println("numberOne * numberTwo: " + (numberOne * numberTwo));
		System.out.println("numberOne / numberTwo: " + ((double)numberOne / (double)numberTwo));
		System.out.println("numberOne % numberTwo: " + (numberOne % numberTwo));					//+, -, *, /, and % are evaluated left to right
		...
		System.out.println("Result of numOneString.compareTo(numTwoString)" + numOneString.compareTo(numTwoString));
	}
}
